...
public class Server {
    ...
    public Server(MainLogger logger, final String filePath, String dataPath, String pluginPath) {
        ...
        this.properties = new Config(this.dataPath + "server.properties", Config.PROPERTIES, new ConfigSection() {
			private static final long serialVersionUID = 2691582217961072433L;
    ...
    public int broadcastMessage(String message) {
        return this.broadcast(message.replace(">", TextFormat.GREEN + ">"), BROADCAST_CHANNEL_USERS);
    }
    ...
    public void titleTick() {
        ...
        String title = (char) 0x1b + "]0;" 
                + "" + this.players.size() + "/" + this.getMaxPlayers() + " " + this.getTicksPerSecond() + " " + usage; 
    ...
    public CompoundTag getOfflinePlayerData(String name) {
        ...
        Position spawn = this.getDefaultLevel().getSafeSpawn(new Vector3());
