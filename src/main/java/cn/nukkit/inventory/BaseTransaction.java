...
public class BaseTransaction implements Transaction {
    ...
    public boolean isEnchantment = false;
    
    public BaseTransaction(Inventory inventory, int slot, Item sourceItem, Item targetItem, boolean ench) {
        this.inventory = inventory;
        this.slot = slot;
        this.sourceItem = sourceItem.clone();
        this.targetItem = targetItem.clone();
        this.creationTime = System.currentTimeMillis();
        this.isEnchantment = ench;
    }
