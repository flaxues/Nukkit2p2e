...
public class CraftingManager {
    ...
    public CraftingManager() {
        ...
        this.registerRecipe((new BigShapedRecipe(Item.get(Item.BOOK, 0, 1),
                " PP",
                " LP"
        )).setIngredient("P", Item.get(Item.PAPER, 0, 1)).setIngredient("L", Item.get(Item.LEATHER, 0, 1)));
        ...
        this.registerRecipe(new BigShapedRecipe(Item.get(Item.ENDER_CHEST, 0, 1),
                ...
                "PSP",
                "PPP"
        ).setIngredient("P", Item.get(Item.OBSIDIAN, 0, 1)).setIngredient("S", Item.get(Item.ENDER_PEARL, 0, 1)));
    }
    ...
    protected void registerTools() {
    	...
    	this.registerRecipe((new BigShapedRecipe(Item.get(Item.ANVIL, 0, 1), 
    			...
    			" I ",
    			"III"
    	)).setIngredient("B", Item.get(Item.IRON_BLOCK)).setIngredient("I", Item.get(Item.IRON_INGOT)));
