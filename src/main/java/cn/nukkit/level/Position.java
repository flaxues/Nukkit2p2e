...
public class Position extends Vector3 {
    ...
    public boolean isBrokenBed()	{
        ...
        Block blockEast = block.getSide(5);
        Block blockWest = block.getSide(4);

        Block b;
        if ((block.meta & 0x08) == 0x08) {
            b = block;
        } else {
            if (blockNorth.getId() == block.getId() && (blockNorth.meta & 0x08) == 0x08) {
                b = blockNorth;
            } else if (blockSouth.getId() == block.getId() && (blockSouth.meta & 0x08) == 0x08) {
                b = blockSouth;
            } else if (blockEast.getId() == block.getId() && (blockEast.meta & 0x08) == 0x08) {
                b = blockEast;
            } else if (blockWest.getId() == block.getId() && (blockWest.meta & 0x08) == 0x08) {
                b = blockWest;
            } else {
                return true;
            }
