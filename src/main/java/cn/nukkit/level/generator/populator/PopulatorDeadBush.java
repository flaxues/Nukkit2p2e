...
public class PopulatorDeadBush extends Populator {
    ...
    private boolean canDeadBushStay(int x, int y, int z) {
        ...
        return (b == Block.AIR && (this.level.getBlockIdAt(x, y - 1, z) == Block.SAND || this.level.getBlockIdAt(x, y - 1, z) == Block.STAINED_CLAY || this.level.getBlockIdAt(x, y - 1, z) == Block.HARDENED_CLAY));
    }
