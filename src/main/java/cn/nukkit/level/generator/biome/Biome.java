...
public abstract class Biome {
    ...
    private Boolean isElevationDefined = null;
    ...
    protected static int grassColor = 0;
    ...
    public static void init() {
        ...
        register(MESA_PLATEAU, new MesaPlateauBiome());
    ...
    public void setElevation(int min, int max) {
        ...
        this.isElevationDefined = new Boolean(true);
    }
    
    public boolean isElevationDefined()	{
    	return !(this.isElevationDefined == null);
    }
