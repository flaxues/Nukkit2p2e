...
public abstract class Command {
    ...
    public static void broadcastCommandMessage(CommandSender source, TextContainer message, boolean sendToSource) {
        ...
        String coloredStr = TextFormat.GRAY + "" + TextFormat.ITALIC + "[" + source.getName() + ": " + (!m.getText().equals(source.getServer().getLanguage().get(m.getText())) ? "%" : "") + m.getText() + "]";

        source.sendMessage(coloredStr);
    }
