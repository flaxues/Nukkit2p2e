package mobs.milk.pureentities.entity.monster;
...
import mobs.milk.pureentities.entity.WalkingEntity;
import mobs.milk.pureentities.entity.monster.walking.Enderman;
...
public abstract class WalkingMonster extends WalkingEntity implements Monster{
    ...
    public boolean entityBaseTick(int tickDiff){
        ...
        if(this instanceof Enderman){
            if(this.level.getBlock(NukkitMath.floorDouble(this.x), (int) this.y, NukkitMath.floorDouble(this.z)) instanceof BlockWater){
