package mobs.milk.pureentities;
...
import mobs.milk.pureentities.blockentity.BlockEntitySpawner;
import mobs.milk.pureentities.entity.animal.walking.*;
import mobs.milk.pureentities.entity.monster.walking.*;
import mobs.milk.pureentities.entity.projectile.EntityFireBall;
import mobs.milk.pureentities.entity.monster.flying.Blaze;
import mobs.milk.pureentities.entity.monster.flying.Ghast;
import mobs.milk.pureentities.task.AutoSpawnTask;
...
public class PureEntities extends PluginBase implements Listener{
    ...
    public void onDisable(){
        Utils.logInfo("Plugin has been disabled");
    }
